export const sendInterviewHtml = (question, interview_id) => {
    ...
    <div>
        <a href="https://ironmental.net/interviews/${interview_id}" style="text-decoration: none; width: 400px; text-align:center; display:block; margin: 0 auto; margin-top: 1rem; background: #33b5e5!important; padding-top: 1rem; color: white; font-size: 1.25rem; padding-bottom: 1rem; font-weight: 600; border-radius: 4px;">
            답변 보기
        </a>
    </div>
